...
为提高效率，可以开启快捷动作，直接从 PopClip 工具栏一键生成指定风格的回复，跳过风格选择对话框：

| 动作 | 说明 |
|------|------|
| **AI Reply** | 完整流程：风格选择 → 生成 → 编辑 |
| **AI Reply — Professional** | 一键生成正式回复 |
| **AI Reply — Friendly** | 一键生成友好回复 |
| **AI Reply — Concise** | 一键生成简洁回复 |
